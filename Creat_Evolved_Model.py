...
#     # Block 7
    ...
    model = ef_block.Sub_Block2_2(model ,'7a',(3,3),(1,1),576,24,160)
    model = ef_block.Sub_Block3_2(model,'7b',960,40,160)
    model = ef_block.Sub_Block3_2(model,'7c',960,40,160)
    
#     # Final
    
    model = ef_block.Final_Block(model ,640)
...
# input_layer = Input(shape=(260,480,1) , name='input_layer')
# Evolved_Model_1 = Evolved_1(input_layer)

# Evolved_Model_1.summary()


# In[ ]:


def Evolved_2(input_layer):
...
#     # Block 5
    ...
    model = ef_block.Sub_Block2_2(model ,'5a',(5,5),(1,1),560,20,112)
...
#     # Block 7
    ...
    model = ef_block.Sub_Block2_2(model ,'7a',(3,3),(1,1),1152,48,320)
    model = ef_block.Sub_Block3_2(model,'7b',1920,80,320)
    model = ef_block.Sub_Block3_2(model,'7c',1920,80,320)
    
#     # Final
    
    model = ef_block.Final_Block(model ,1280)
...
# input_layer = Input(shape=(260,480,1) , name='input_layer')
# Evolved_Model_2 = Evolved_2(input_layer)

# Evolved_Model_2.summary()


# In[ ]:


def Evolved_3(input_layer):
...
#     # Block 7
    ...
    model = ef_block.Sub_Block2_2(model ,'7a',(3,3),(1,1),2304,96,640)
    model = ef_block.Sub_Block3_2(model,'7b',3840,160,640)
    model = ef_block.Sub_Block3_2(model,'7c',3840,160,640)
    
#     # Final
    
    model = ef_block.Final_Block(model ,2560)
...
# input_layer = Input(shape=(260,480,1) , name='input_layer')
# Evolved_Model_3 = Evolved_3(input_layer)

# Evolved_Model_3.summary()
...
#     # Final
    ...
    model = ef_block.Final_Block(model ,448)
...
#     # Final
    ...
    model = ef_block.Final_Block(model ,896)
